...
namespace GitClientVS.UI.Controls.DiffControlUtils
{
    public static class DiffColors
    {
        ...
        public static readonly SolidColorBrush DarkWordAddedBackground = DarkLineAddedBackground;
        public static readonly SolidColorBrush DarkWordRemovedBackground = DarkLineRemovedBackground;
