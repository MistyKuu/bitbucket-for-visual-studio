...
namespace BitBucket.REST.API.Interfaces
{
    public interface IPullRequestsClient
    {
        ...
        Task<string> GetPullRequestDiff(string repositoryName, string owner, long id);
        ...
        Task<PullRequest> CreatePullRequest(PullRequest pullRequest, string repositoryName, string owner);
    }
}